...
def generate_launch_description():
    ...
    xacro_path = os.path.join(
        pkg_walkie_description, "robots", "gz_walkie_1arm_moveit.urdf.xacro"
    )
    ...
    controller_config = os.path.join(
        pkg_left_arm_moveit_config, "config", "ros2_controllers.yaml"
    )
    ...
    use_sim_time = PythonExpression(
        ["'", hardware_type, "' == 'gazebo' or '", hardware_type, "' == 'isaac'"]
    )

    # ========================================================================
    # 2. GENERATE ROBOT & SERVO CONFIG
    # ========================================================================
    ...
    servo_params = {
        ...
        .yaml(os.path.join(pkg_left_arm_moveit_config, "config", "servo.yaml"))
        .to_dict()
    }
    ...
    # A. ROS 2 Control Node (Only for Real/Mock Robot)
    control_node = Node(
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            # Launching Servo as a node component makes ROS 2 intraprocess communication more efficient.
    ...
    ld.add_action(
        DeclareLaunchArgument("launch_as_standalone_node", default_value="false")
    )
